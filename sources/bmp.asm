...
VIDEO_MEMORY_ADDRESS_VGA equ 0A000h
BMP_PALETTE_SIZE 	 	 equ 400h
BMP_HEADER_SIZE 	 equ 54
BMP_PATH_LENGTH   	 	 equ  40
BMP_MAX_WIDTH 			EQU 320
BMP_HEADER_SIZE			 EQU 54
BMP_HEADER_WIDTH_OFFSET  EQU 12h
BMP_HEADER_HEIGHT_OFFSET EQU 16h
; Struc ofsets
BMP_FILE_HANDLE_OFFSET 	 equ 0
BMP_HEADER_OFFSET 		 equ BMP_FILE_HANDLE_OFFSET + 2
BMP_PALETTE_OFFSET 		 equ BMP_HEADER_OFFSET + BMP_HEADER_SIZE
BMP_WIDTH_OFFSET 		 equ BMP_PALETTE_OFFSET + BMP_PALETTE_SIZE
BMP_HEIGHT_OFFSET 		 equ BMP_WIDTH_OFFSET + 2
BMP_IMAGE_PATH 			 equ BMP_HEIGHT_OFFSET + 2
BMP_LOADED_OFFSET		equ BMP_IMAGE_PATH + BMP_PATH_LENGTH + 1
; for seek
BMP_SKIP_SIZE			 equ BMP_HEADER_SIZE + BMP_PALETTE_SIZE
...
@@NextLine:
	...
	mov edx,offset _bmpSingleLine
	int 21h

	; Copy line into video memory
	cld 							; Clear direction flag, for movsb
	mov ax,imgWidth
	mov esi,offset _bmpSingleLine
